...
class GuessTest {
	...
	// testServerMorraInfoInit()
	//
	// Test if the MorraInfo member, gameInfo, in the Server instance is correctly instantiated with the correct class type, MorraInfo
	//
	@Test
