...
// Description of File:
//
// The GuessTest.java file for ClientWordGuessSpring2020 contains all of the test cases used to test the
// Client class. The test cases includes the testing of the member variables, the isAlive() Thread Class method, and the WordGuessInfo object gameInfo variables.
// The Client c is instantiated with the port value of 5555 and the IP address of "127.0.0.1" (Local Host) using the parameterized
// constructor of Client.
//
// GuessTest: Includes the test cases to test the class Client
class GuessTest {

	Client c; // Variable of type Client, c
	...
	void setUpCode()
	{
		c = new Client(client->{}, 5555, "127.0.0.1");
	} // end setUpCode()
	...
	//
	// Test if the Client instance, c, is initialized correctly in that the gameInfo member of type WordGuessInfo is not null as the object was instantiated
	//
	@Test
	...
	void testPlayerGuess() {
		assertNull(c.gameInfo.playerGuess, "Player guess should be null but is " + c.gameInfo.playerGuess);
	} // end testPlayerGuess()
