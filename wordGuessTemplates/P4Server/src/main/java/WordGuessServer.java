...
public class WordGuessServer extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		serverInfoTitle.setFont(Font.font(null, 15));
		serverInfoTitle.setFill(Color.AZURE);
		serverInfoTitle.setStyle("-fx-stroke-width: 1; -fx-stroke: cornflowerblue;");
		...
		title.setStyle("-fx-stroke-width: 2; -fx-stroke: cornflowerblue;");
		...
		portText.setFill(Color.AZURE);
		portText.setStyle("-fx-stroke-width: 1; -fx-stroke: cornflowerblue;");
		...
		serverStatus.setFill(Color.AZURE);
		serverStatus.setStyle("-fx-stroke-width: 1; -fx-stroke: cornflowerblue;");
		...
		numUsers.setFill(Color.AZURE);
		numUsers.setStyle("-fx-stroke-width: 1; -fx-stroke: cornflowerblue;");
